...
let WOMEN = require('../../products/products.json');
let MEN = require('../../products/products2.json');
let KIDS= require('../../products/products3.json');
let TRENDING = require('../../products/products4.json');
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.categoriesListContainer}>
          <View style={styles.barContainer}>
            <TouchableOpacity 
              ...
              onPress={() => this.renderListProducts(MEN.products)}
            >
            ...
            <TouchableOpacity 
              style={styles.categoryContainer}
              onPress={() => this.renderListProducts(WOMEN.products)}
            >
              <Text style={styles.categoryText}>
             WOMEN
              </Text>
            ...
            <TouchableOpacity 
              style={styles.categoryContainer}
              onPress={() => this.renderListProducts(KIDS.products)}
            >
              <Text style={styles.categoryText}>
             KIDS
              </Text>
            ...
            <TouchableOpacity 
              style={styles.categoryContainer}
              onPress={() => this.renderListProducts(TRENDING.products)}
            >
              <Text style={styles.categoryText}>
             TRENDING
              </Text>
